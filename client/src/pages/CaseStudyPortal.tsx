...
import { ArrowRight, CheckCircle, LineChart, Users, Zap, Code, Smartphone, Brain, FileDown } from "lucide-react";
          ...
          <div className="flex justify-center mb-8">
            <div className="w-2/3 max-w-md">
              <div className="relative">
                ...
                />
                <div
                  className="absolute top-0 right-0 m-2 w-6 h-6 flex items-center justify-center shadow-lg cursor-pointer bg-white rounded-full"
                  title="Enlarge"
                  onClick={() => handleImageClick("/images/Case-Studys/CS-Portal/Benefits_Customer_Success_Portal.png")}
                >
                  <img 
